...
<body class="font-sans antialiased bg-gray-100 text-gray-900">
    ...
    <!--
        Shared image lightbox popup, whenever a thumbnail with a `data-lightbox` attribute is clicked. 
        Native <dialog> gives us the backdrop, top-layer stacking, and Escape-to-close for free.
    -->
    <dialog id="image-lightbox" class="m-auto max-w-3xl w-[90vw] rounded-lg bg-transparent p-0 backdrop:bg-black/70">
        <div class="relative">
            <!-- Positioned inside the image bounds (not overflowing it) to avoid triggering page scroll -->
            ...
            <!-- src is set/cleared by JS on open/close -->
